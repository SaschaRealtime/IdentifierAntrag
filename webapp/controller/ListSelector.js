sap.ui.define([
		...
		return BaseObject.extend("realtime.identifier.benutzerantrag.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias realtime.identifier.benutzerantrag.model.ListSelector
			 */
			 ...
			 * @return {realtime.identifier.benutzerantrag.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
