sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("realtime/identifier/benutzerantrag/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#IdentifierBenutzerantrag-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#IdentifierBenutzerantrag-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("realtime.identifier.benutzerantrag.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["realtime/identifier/benutzerantrag/localService/mockserver"], function (mockserver) {
