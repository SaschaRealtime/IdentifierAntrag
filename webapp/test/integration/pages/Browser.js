					...
					iChangeTheHashToObjectN : function (iObjIndex) {
						return this.waitFor(this.createAWaitForAnEntitySet({
							...
							success : function (aEntitySet) {
								Opa5.getHashChanger().setHash("/AntragSet/" + aEntitySet[iObjIndex].Antnr);
							}
						}));
					},
					...
					iChangeTheHashToTheRememberedItem : function () {
						return this.waitFor({
							success : function () {
								...
								Opa5.getHashChanger().setHash("/AntragSet/" + sObjectId);
							}
						});
					},
					...
					iShouldSeeTheHashForObjectN : function (iObjIndex) {
						return this.waitFor(this.createAWaitForAnEntitySet({
							...
							success : function (aEntitySet) {
								...
								Opa5.assert.strictEqual(sHash, "AntragSet/" + aEntitySet[iObjIndex].Antnr, "The Hash is not correct");
							}
						}));
					},
						...
						return this.waitFor({
							success : function () {
								var sObjectId = this.getContext().currentItem.id,
									...
									sHash = oHashChanger.getHash();
								Opa5.assert.strictEqual(sHash, "AntragSet/" + sObjectId, "The Hash is not correct");
							}
						});
					},
